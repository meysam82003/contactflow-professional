...
html=html.replaceAll('Personal Ultimate 3.0','Personal Ultimate 3.2').replaceAll('3.0.0 Ultimate','3.2.0 Ultimate').replaceAll('ContactFlow 3.0','ContactFlow 3.2');
write('app.js',read('app.js').replace("const APP_VERSION = '3.0.0'","const APP_VERSION = '3.2.0'"));
