...
async function fullBackup(){
  const stores=['contacts','imports','meta','settings','artifacts','contact_flags','campaigns','ad_requests','telegram_accounts','templates','activity'],data={format:'ContactFlowBackup',version:5,appVersion:VERSION,createdAt:new Date().toISOString(),stores:{},connectors:{}};
