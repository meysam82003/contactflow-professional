...
func install() error {
	if msg("به نصب ContactFlow Personal Ultimate 3.6 خوش آمدید.\n\nورود اتمیک، تلگرام بدون API، هوش شهری و ابزارهای آفلاین برای Desktop، Android، PWA و Telegram Mini App.", "ContactFlow Setup", 0x40) != 1 {
		return nil
	}
