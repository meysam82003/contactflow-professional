...
func install() error {
	if msg("به نصب ContactFlow Personal Ultimate 3.1 خوش آمدید.\n\nLocal‑First، Telegram Web‑MTProto QR، Google Drive Sync و Mini App بدون حساب ContactFlow.", "ContactFlow Setup", 0x40) != 1 {
		return nil
	}
