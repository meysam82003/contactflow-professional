...
func install() error {
	if msg("به نصب ContactFlow Personal Ultimate 3.3 خوش آمدید.\n\nیک هسته مشترک برای Desktop، Android، PWA و Telegram Mini App با خروجی مخاطبین Telegram.", "ContactFlow Setup", 0x40) != 1 {
		return nil
	}
