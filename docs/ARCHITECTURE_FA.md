# معماری ContactFlow Personal Ultimate 3.3

## هسته مشترک

پوشه `web/` Source of Truth رابط نسخه ۳.۳ است. Workflow انتشار Connector را Build می‌کند و همان خروجی را بدون Fork شدن منطق در همه پوسته‌ها قرار می‌دهد:
